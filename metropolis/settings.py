...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-r^opp#apiz6^3t4q(urn==^w(uxa*ng!5zjux%k(55-pq!k_%^')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.empresa_sidebar',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = 'no-reply@metropolis.local'
