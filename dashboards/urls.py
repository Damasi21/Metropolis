...
urlpatterns = [
    ...
    path('<slug:slug>/fluxo-de-caixa/', dashboard_fluxo_caixa, name='dashboard_fluxo_caixa'),
    ...
    path('<slug:slug>/parametros/previsto-realizado/', previsto_realizado, name='previsto_realizado'),
